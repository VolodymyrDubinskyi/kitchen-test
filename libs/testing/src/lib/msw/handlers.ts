...
import { product, productCreated, productPage } from '../captures'
...
export const handlers = [
  ...
  http.get(`${UPSTREAM_BASE_URL}/products/search`, () => HttpResponse.json(productPage)),
  http.get(`${UPSTREAM_BASE_URL}/products/:id`, () => HttpResponse.json(product)),
